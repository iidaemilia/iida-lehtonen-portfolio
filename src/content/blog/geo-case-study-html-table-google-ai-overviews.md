---
title: "GEO Case Study: How a Simple HTML Table Earned 6,000 Impressions in Google AI Overviews"
description: "A GEO case study: publishing existing customer data as an indexable HTML table earned 38,000 Google impressions in three months, 15% of them in Google AI Overviews and AI Mode."

excerpt: "The information customers needed already existed, but search engines and AI systems could not access it. A simple, indexable HTML page turned it into a measurable content asset."
...
heroImage: "../../assets/images/geo-case-study-hero.png"
heroAlt: "Woman reviewing a data table and upward-trending chart on a desktop monitor"
...
faq:
  - question: "Why did a plain HTML table earn AI search visibility without long-form content?"
    answer: >-
      Because the format matched the question. The customer's question
      connected two variables, location and availability, and a table exposes
      that relationship more clearly than prose. AI systems need an
      unambiguous source to extract answers from, and in this case structure
      did that work better than additional copy would have.
  - question: "How much of the page's visibility came from AI search?"
    answer: >-
      About 15.4% of the page's Google impressions came from AI Overviews and
      AI Mode, roughly 6,000 out of 38,600 impressions in three months. On top
      of that, about 4% of measured sessions came from identifiable AI
      assistants such as ChatGPT and Perplexity. The first figure is
      visibility, the second is traffic, and they cannot be added together.
  - question: "Why publish a separate page instead of relying on the existing lookup tool?"
    answer: >-
      The lookup tool served customers who were already in the sales journey,
      but its results were invisible to crawlers and AI systems. The new page
      made the same information available at the research stage, before the
      customer reached the site. It complemented the tool rather than replaced
      it, and clicks to the core product page grew 17.7% over the same period.
  - question: "Does this prove that HTML tables improve AI search visibility?"
    answer: >-
      No. The page answered a question with existing search demand, on an
      established domain, and the measurement window was three months. What
      the case shows is that information previously locked inside an
      interactive tool earned measurable visibility in both traditional and
      generative search once it was published in an indexable form. The format
      was one factor among several.
  - question: "Could the same approach work on other websites?"
    answer: >-
      The approach transfers, even if the numbers may not. Most companies hold
      useful data inside calculators, configurators or availability checkers
      that crawlers cannot operate. If customers ask a factual question that
      this data answers, publishing a stable, indexable version of it is a
      low-cost experiment with measurable results.

draft: false
---

Most advice about [generative engine optimization (GEO)](https://iidalehtonen.com/writing/seo-vs-aeo-vs-geo/) is about writing: clearer answers, better headings, more authoritative articles. All of that assumes the information AI systems should cite is accessible to them in the first place. In this case it was not, and fixing that became the whole project.
...
[Search engines and AI systems can only cite information they can access as stable source material](https://iidalehtonen.com/writing/can-ai-read-your-website/). When data appears only after a form or a dynamic lookup, it does not exist as content from a crawler's point of view. The customer experience can be excellent while discoverability is close to zero.
...
[Generative AI impressions, AI assistant referrals and Google organic traffic answer different questions](https://iidalehtonen.com/writing/how-i-track-ai-search-visibility-method/). I reported them separately instead of merging them into one "AI traffic" figure. Less dramatic, more accurate.
