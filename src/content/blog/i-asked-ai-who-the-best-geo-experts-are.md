---
title: "I Asked AI Who the Best GEO Experts Are. Here's Where the Answers Came From."
description: >-
  I tested how AI answers "best GEO experts to follow" queries and traced every
  answer back to its sources. Here's what I learned.
...
heroImage: "../../assets/images/i-asked-ai-hero.png"
heroAlt: "Person comparing ranked expert lists beside a laptop"
...
faq:
  - question: "Where do AI search tools get their 'best experts' recommendations?"
    answer: >-
      Largely from the same places Google does. In my measurements across AI
      Overviews, Gemini, ChatGPT and Claude, most expert recommendations traced
      back to "best X" listicles, and Ahrefs' research found that such lists make
      up 43.8% of the page types ChatGPT cites for recommendation-style queries.
  - question: "Are the expert lists that AI tools cite reliable?"
    answer: >-
      They vary. Many are useful overviews, but a large share are content
      marketing: in my checked sample of 16 frequently cited expert lists,
      roughly 70 to 75% were written by a person or organization that appears on
      the list itself. That doesn't make them worthless, it makes them marketing,
      and they should be read the same way you'd read any vendor's own material.
  - question: "How can I check the sources behind an AI answer?"
    answer: >-
      Ask the tool directly what sources the answer is based on, then open them.
      Check who published each source, whether the author appears on their own
      list, and whether the ranking has any stated criteria or data behind it.
      This usually takes only a couple of minutes.
  - question: "Should a company choose a GEO or AI search partner based on an AI recommendation?"
    answer: >-
      Use the AI answer as a starting shortlist, not as a decision. The model
      isn't vouching for anyone; it's summarizing the most citable content of
      that week. Ask candidates for evidence of real work: projects,
      measurements and documented methods.
  - question: "Does traditional SEO content still work in AI search?"
    answer: >-
      To a large extent, yes. Fresh, structured, citable content performs in AI
      answers much like it does in Google, and freshness seems to matter even
      more: in Ahrefs' data, 79.1% of the lists ChatGPT cited had been updated
      within the year. That's also why publishing your own data and methods is a
      durable way to build AI search visibility.
...
This matches what larger studies show. In December 2025, Ahrefs' Glen Allsopp [analyzed 750 "best software, product or agency" prompts in ChatGPT](https://ahrefs.com/blog/best-lists-research/) and categorized 26,283 source URLs behind the answers:
