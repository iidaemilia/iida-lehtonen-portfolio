...
faq:
  - question: "Does YouTube help your GEO strategy?"
    answer: >-
      Yes, but only on specific platforms. Large-scale citation data shows
      Google AI Overviews, Google AI Mode and Perplexity generate over 90% of
      YouTube citations in AI search. ChatGPT cites YouTube mainly for
      instructional how-to queries, and Gemini and Copilot rarely cite it at
      all. YouTube supports GEO on Google's AI surfaces and Perplexity; for
      other platforms, text content does the work.
  - question: "Which AI search engines cite YouTube videos?"
    answer: >-
      In Otterly.ai's 100M+ citation dataset, YouTube citations break down as:
      Perplexity 38.7%, Google AI Overviews 36.6%, Google AI Mode 19.6%, ChatGPT
      4.4%, Microsoft Copilot 0.5% and Gemini 0.2%. Only Google's AI surfaces
      cite specific timestamps within videos.
  - question: "Do views and subscribers affect AI citations?"
    answer: >-
      No meaningful correlation has been found. In Otterly.ai's data, view
      counts, likes and subscriber numbers showed near-zero correlation with
      citation frequency (r ≈ -0.03). 40.8% of AI-cited videos had fewer than
      1,000 views. Structure and reference value appear to matter more than
      popularity.
  - question: "What kind of YouTube videos do AI search engines cite?"
    answer: >-
      Long-form reference content: 94% of AI citations go to long-form videos,
      with 10–20 minutes as the most cited length. How-to queries, visual
      demonstrations and product comparisons are the query types most likely
      to trigger video citations. Shorts account for only 5.7% of citations.
  - question: "How do I optimize a YouTube video for AI search?"
    answer: >-
      Make it work as a reference: choose a how-to or demonstration topic, aim
      for 10–20 minutes, add correctly formatted chapters (first timestamp at
      00:00, at least three timestamps, chapters of 10+ seconds), and write a
      description that summarizes the video, names its key entities and
      includes the chapter list. Keep the video's facts current, since recency
      correlates weakly but positively with citations.

sources:
  - title: "Otterly.ai: The YouTube Citation Study 2026"
    url: "https://otterly.ai/blog/youtube-ai-citation-study-2026/"
  - title: "BrightEdge: How Google AI Overviews and ChatGPT Use YouTube Differently"
    url: "https://www.brightedge.com/resources/weekly-ai-search-insights/google-ai-overviews-vs-chatgpt-youtube-usage"
  - title: "BrightEdge: YouTube's Growing Impact on Google AI Overviews"
    url: "https://www.brightedge.com/blog/youtubes-growing-impact-google-ai-overviews-what-marketers-need-know"
  - title: "YouTube Help: Video chapters"
    url: "https://support.google.com/youtube/answer/9884579"
  - title: "Google Search Central: Video structured data and key moments"
...
[Otterly.ai's YouTube Citation Study 2026](https://otterly.ai/blog/youtube-ai-citation-study-2026/) analyzed over 100 million AI citations across six AI search platforms. The headline numbers put the "YouTube is huge in AI search" narrative in perspective:
...
[BrightEdge's analysis](https://www.brightedge.com/blog/youtubes-growing-impact-google-ai-overviews-what-marketers-need-know) of which queries trigger YouTube citations found three dominant categories:
...
Chapters work like subheadings on a webpage. [YouTube's own video chapters guidelines](https://support.google.com/youtube/answer/9884579) spell out the formatting requirements:
...
If you also publish videos on your own site, [Google Search Central's video structured data documentation](https://developers.google.com/search/docs/appearance/structured-data/video) covers the separate key moments markup for web pages.
